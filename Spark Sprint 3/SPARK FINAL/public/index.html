...
<body>
  ...
  <div id="phase-select" class="space-bg hidden">
    ...
    <div class="phase-box">
      ...
      <div class="phase-screen-title">Escolha a Fase</div>
  ...
  <div id="credits-screen" class="space-bg hidden">
    ...
    <div class="credits-box">
      <div class="credits-rocket" id="credits-rocket">🚀</div>
      <h2 class="credits-main-title">✦ Créditos ✦</h2>
      <div class="credits-group" id="cg-0"><div class="credits-role">Grupo</div><div class="credits-name big">Spark 🚀</div></div>
      <div class="credits-divider" id="cd-0"></div>
      <div class="credits-group" id="cg-1"><div class="credits-role">Desenvolvedor</div><div class="credits-name">Guilherme Martins de Almeida</div></div>
      <div class="credits-group" id="cg-2"><div class="credits-role">Desenvolvedor</div><div class="credits-name">Fabricio de Sá Caldas</div></div>
      <div class="credits-divider" id="cd-1"></div>
      <div class="credits-group" id="cg-3"><div class="credits-role">Product Owner</div><div class="credits-name">Guilherme Da Cruz Andrade</div></div>
      <div class="credits-group" id="cg-4"><div class="credits-role">Scrum Master</div><div class="credits-name">Nathan Fernandes</div></div>
      <div class="credits-group" id="cg-5"><div class="credits-role">Quality Assurance</div><div class="credits-name">Rian Santo Das Virgens</div></div>
      <div class="credits-divider" id="cd-2"></div>
      <div class="credits-group" id="cg-6"><div class="credits-role">Professor</div><div class="credits-name big gold">João Roberto Ursino Da Cruz</div></div>
      <div class="credits-divider" id="cd-3"></div>
      <div class="credits-group" id="cg-7"><div class="credits-thanks">Obrigado por jogar! ⭐</div><div class="credits-year">2025</div></div>
      <button class="btn-ghost credits-btn-home" id="btn-credits-home">← Voltar</button>
    </div>
    <div class="planet planet-1">🪐</div>
    <div class="planet planet-2">🌕</div>
    <div class="planet planet-3">🌍</div>

...
<body>
  ...
  <div id="splash" class="space-bg">
    ...
    <div class="splash-content">
      ...
      <div class="splash-title">
        ...
        <h1>
          <span id="splash-title-1">SPARK!</span><br>
  ...
  <div id="phase-select" class="space-bg hidden">
    ...
    <div class="star-wrap">
      ...
      <div class="star-bottom-btns">
        <button class="btn-credits-phase bloqueada" id="btn-phase-credits" disabled>Epílogo</button>
  ...
  <div id="settings-modal" class="modal-overlay hidden">
    <div class="modal-box">
      ...
      <button class="btn-ghost" id="btn-settings-credits" style="width:100%;margin-bottom:10px;">Créditos</button>

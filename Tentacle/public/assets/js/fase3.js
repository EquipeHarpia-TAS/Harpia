...
function atualizarFisica(delta = 1){
  ...
  moedas.forEach(m=>{
    ...
    if(Math.abs(estado.px+SPRITE_W/2-m.x)<30&&Math.abs(estado.py+SPRITE_H/2-my)<30){m.coletada=true;pontos+=10;try{ efeitoMoeda.currentTime=0; efeitoMoeda.play(); }catch(e){}}
  });
